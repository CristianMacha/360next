...
export default function NotFound() {
    ...
    return (
        <div className="flex flex-col justify-center gap-10 items-center w-full h-screen overflow-hidden">
            <h1 className="font-primary font-bold text-[320px] text-center text-white flex flex-row gap-6 items-center" style={{ WebkitTextStrokeWidth: 8, WebkitTextStrokeColor: '#000000' }}>4 <svg xmlns="http://www.w3.org/2000/svg" width="251" height="251" viewBox="0 0 251 251" fill="none">
            ...
            <p className="font-primary font-normal text-[20px] text-center w-[670px]">Pedimos disculpas por cualquier interrupción del continuo espacio-tiempo. No dude en regresar a nuestra página de inicio.</p>

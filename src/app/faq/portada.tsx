...
export default function Portada() {
    ...
    return (
        <section className="flex flex-col gap-10 px-[16px] md:px-[40px]">
            <h1 className="font-primary text-[60px] md:text-[96px] md:leading-[80px]">Preguntas y Respuestas</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                <div className="h-[678px] rounded-[40px] overflow-hidden" style={{ backgroundImage: `url(${cubeImage})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>

        ...
        <section className="px-[16px] md:px-[40px] py-52 flex flex-col justify-center items-center gap-16 relative">
            ...
            <div className="flex flex-col items-end w-full">
                <div className="flex flex-col gap-6">
                    <p className="font-primary tex-[32px] font-medium text-justify w-auto md:w-[730px]">Desde el momento en que se fundó nuestra empresa, hemos ayudado a nuestros clientes a encontrar soluciones excepcionales para sus negocios, creando marcas y productos digitales memorables. Nuestra experiencia crece cada año y nuestra experiencia acumulada nos permite desarrollar productos exactamente como deben ser.</p>
                    <div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="344" height="275" viewBox="0 0 344 275" fill="none" className="absolute opacity-30 md:opacity-60 -z-[1]">

...
export default function Form() {
    ...
    return (
        <div className="pt-[64px] px-[16px] md:px-[40px]">
            <h2 className="font-primary text-[32px] sm:text-[10px] md:text-[76px]">Contáctanos</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-16">
                <div>
                    <form onSubmit={handleSubmit}>
                        <div className="flex flex-col gap-4 font-primary">
                            <div className="flex flex-col gap-2">
                                <label htmlFor="name" className="font-primary font-light text-[20px] md:text-[24px]">Nombre</label>
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="email" className="font-primary font-light text-[20px] md:text-[24px]">Correo electrónico</label>
                            ...
                            <div className="flex flex-col gap-2">
                                <label htmlFor="message" className="font-primary font-light text-[20px] md:text-[24px]">Mensaje</label>

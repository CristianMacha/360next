        ...
        <section className="flex pt-[32px] flex-col items-start lg:pt-0 relative">
            ...
            <div className="flex flex-col items-start lg:px-[40px] lg:flex-row lg:justify-center">
                <div className="flex py-0 px-[16px] items-start gap-[8px] lg:pt-[50px] lg:pr-[36px] lg:pl-0 lg:pb-0 lg:rounded-t-none lg:rounded-bl-[50px] lg:rounded-br-none lg:border-b lg:border-[#c7c7c7] lg:self-stretch relative">
                    <h2 className="title-small md:title-medium lg:title-large sticky top-[50px] h-auto lg:h-[500px] ">Ofrecemos</h2>
                </div>
                <div className="flex pt-[70px] pb-[64px] flex-col justify-center items-center gap-[60px] rounded-bl-[50px] rounded-br-[50px] border-b border-[#C7C7C7] md:py-[100px] lg:px-[32px] md:gap-y-[40px] md:gap-x-[40] md:flex-1 md:flex-row md:flex-wrap md:rounded-t-none md:rounded-bl-none md:rounded-br-[50px] md:border-b md:border-l">
                    <div className="flex px-[16px] pb-[16px] flex-col items-start gap-[12px] border-b border-[#c7c7c7] lg:border-b-0 w-auto lg:w-[300px] backdrop-blur-sm bg-white/30">
                        <h3 className="content-large font-medium">Branding</h3>
                    ...
                    <div className="flex px-[16px] pb-[16px] flex-col items-start gap-[12px] border-b border-[#c7c7c7] lg:border-b-0 w-auto lg:w-[300px]">
                        <h3 className="content-large font-medium">Event Planner</h3>
                        <h4 className="content-small">Una identidad de marca atemporal y memorable que ayuda a las empresas a establecer una presencia fuerte y consistente en el mercado.</h4>
                    </div>
                    <div className="flex px-[16px] pb-[16px] flex-col items-start gap-[12px] border-b border-[#c7c7c7]  lg:border-b-0 w-auto lg:w-[300px]">
                        <h3 className="content-large font-medium">Diseño Web</h3>
                        <h4 className="content-small">Una identidad de marca atemporal y memorable que ayuda a las empresas a establecer una presencia fuerte y consistente en el mercado.</h4>
                    </div>
                    <div className="flex px-[16px] pb-[16px] flex-col items-start gap-[12px] w-auto lg:w-[300px]">
                        <h3 className="content-large font-medium">Desarrollo Web</h3>
                        <h4 className="content-small">Una identidad de marca atemporal y memorable que ayuda a las empresas a establecer una presencia fuerte y consistente en el mercado.</h4>
                    </div>
                </div>
            </div>

...
export default function Portada() {
    ...
    return (
        <section className="h-auto px-[16px] md:px-[40px] flex flex-col gap-5 md:gap-14 justify-start items-center py-[16px] md:pb-[40px] md:pt-[70px]">
            <div className="flex flex-col gap-16 md:gap-4 md:flex-row justify-between w-full items-center py-40">

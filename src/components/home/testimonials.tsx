        ...
        <section className="flex py-[24px] h-screen px-[16px] gap-[8px] bg-white lg:px-[40px] lg:pt-[100px] lg:pb-[36px] justify-center lg:items-center" style={{backgroundImage: `url(${backgroundUrlImage})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
            <div className="flex flex-col justify-center items-start gap-[100px] flex-1 lg:justify-between lg:items-end lg:flex-row lg:gap-[auto]">
                <div className="flex flex-col justify-center items-start gap-[40px] self-stretch lg:gap-[200px]">
                    <h2 className="text-black font-primary text-[60px] font-medium not-italic leading-[normal] lg:text-[112px]">Nuestros Clientes</h2>
                ...
                <h3 className="text-black font-primary text-[20px] not-italic font-normal leading-[normal] lg:flex lg:flex-1 lg:h-[211px] lg:flex-col lg:justify-end lg:text-[32px] lg:font-medium">Un cliente satisfecho es el mejor indicador de éxito de la colaboración y enfoque de un proyecto.</h3>
            </div>
        </section>
    )
}
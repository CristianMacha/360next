export default function Testimonials() {
    return (
        <section className="flex py-[24px] h-screen px-[16px] items-start gap-[8px] self-stretch bg-white lg:px-[40px] lg:pt-[100px] lg:pb-[36px] lg:justify-center lg:items-center" style={{backgroundImage: 'url(https://firebasestorage.googleapis.com/v0/b/dev-system2023.appspot.com/o/360%2FtestimonialBackground.jpg?alt=media&token=69c5d301-13e5-4b15-be93-f36fed4197a3)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>

...
export default function Comment({ image, name, comment, position }: CommentProps) {
    ...
    return (
        <div className={`relative ${styles.comment}`}>
            <div className={`bg-white p-1 rounded-t-full rounded-br-full flex justify-center items-center content-center hover:scale-[1.2] transition-all relative ${styles.avatar}`}>
